...
_DEPT_MAP = {
    '문과': 0, '인문': 0, '인문학': 0, '역사': 0, '철학': 0, '문학': 0, '언어': 0, '음악학': 0, '영어영문학': 0,
    '경영': 1, '경영학': 1, '경제': 1, '경제학': 1, '회계': 1, '마케팅': 1, '무역': 1, '국제통상': 1, '국제통상학': 1,
    '통계': 2, '수학': 2, '통계학': 2, '수리': 2,
    '컴퓨터': 3, '컴퓨터공학': 3, '소프트웨어': 3, '소프트웨어공학': 3, '정보통신': 3, '정보통신공학': 3, '정보': 3, '경영정보': 3,
    '전자': 4, '전자공학': 4, '전기': 4, '전기전자': 4,
    '디자인': 5, 'ui': 5, 'ux': 5,
    '비전공': 6,
    '기계': 7, '기계공학': 7, '자동차': 7, '자동차공학': 7, '산업공학': 7,
    '항공': 8, '항공우주': 8, '항공우주공학': 8, '해양': 8, '해양공학': 8, '토목': 8, '토목공학': 8, '건축': 8, '건축학': 8,
    '화학': 9, '화학공학': 9, '신소재': 9, '신소재공학': 9, '에너지': 9, '에너지공학': 9, '식품': 9, '식품공학': 9,
    '바이오': 10, '바이오공학': 10, '생명': 10, '생명과학': 10, '생물': 10, '생물학': 10, '간호': 10, '간호학': 10, '약학': 10, '약': 10, '환경': 10, '환경학': 10,
    '사회복지': 11, '사회복지학': 11, '심리': 11, '심리학': 11, '교육': 11, '교육학': 11, '법학': 11, '법': 11,
    '관광': 12, '관광학': 12,
    '지구과학': 13, '지구': 13, '농학': 13, '농': 13,
}
